...
In the main window, click **Admin \> Incident Management \> Incident Timescale**. The Incident Timescale window displays. ![Incident Timescale 6.1](../Resources/Images/Admin - Incident/Incident-Timescale-6.1.png)
